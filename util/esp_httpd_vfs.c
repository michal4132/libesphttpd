...
static size_t MEM_ATTR getFilepath(HttpdConnData *connData, char *filepath, size_t len) {
    struct stat s;
    int outlen;
...
CgiStatus MEM_ATTR cgiEspVfsGet(HttpdConnData *connData) {
...
bool MEM_ATTR cgiEspVfsBasePath(const char *bp){
